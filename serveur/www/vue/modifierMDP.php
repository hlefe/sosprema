...
<h1> Profil </h1>
  <form method="post" action="index.php?controleur=controleurBenevol&action=modifierMotDePasse">
    ...
    <input required type="text" name="oldMDP" placeholder="mot de passe" />
    
    <label for="prenom">Nouveau mot de passe</label>
    <input required type="text" name="newMDP" placeholder="mot de passe" />

    <label for="prenom">Confirmer nouveau mot de passe</label>
    <input required type="text" name="newMDPVerif" placeholder="mot de passe" />
