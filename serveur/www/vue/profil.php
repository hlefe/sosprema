                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" required type="text" name="nom" value="<?php echo $utilisateurConnecter->nom;?>" />
                        </div>
                        <div class="form-group">
                                <label for="prenom">Prénom</label>
                                <input class="form-control" required type="text" name="prenom" value="<?php echo $utilisateurConnecter->prenom;?>" />
                        </div>
                        <div class="form-group">
                                <label for="email">Adresse Mail</label>
                                <input class="form-control" required type="email" name="email" value="<?php echo $utilisateurConnecter->email;?>" />
                        </div>
                    </div>
            ...
            <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="numRue" value="<?php echo $utilisateurConnecter->numRue;?>" />
                        </div>
                        <div class="form-group"> 
                            <label for="nomRue">Nom de rue</label>
                            <input class="form-control" type="text" name="nomRue" value="<?php echo $utilisateurConnecter->nomRue;?>" />
                        </div>
                        <div class="form-group">                  
                            <label for="codePostal">Code postal</label>
                            <input class="form-control" type="text" name="codePostal" value="<?php echo $utilisateurConnecter->codePostal;?>" />
                        </div>
                        <div class="form-group">
                            <label for="ville">Ville</label>
                            <input class="form-control" type="text" name="nomVille" value="<?php echo $utilisateurConnecter->nomVille;?>" />
                        </div>
                        <div class="form-group">
                            <label for="departement">Département</label>
                            <input class="form-control" type="text" name="nomDepartement" value="<?php echo $utilisateurConnecter->nomRegion;?>" />
                        </div>
                        <div class="form-group">
